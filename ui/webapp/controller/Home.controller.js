sap.ui.define([
	...
	function (MyController, Fragment, Dialog, DialogType, UIComponent, FlexibleColumnLayoutSemanticHelper) {
		...
		return MyController.extend("com.bosch.sbs.vuu7hc.ui.controller.Home", {
			onInit: function () {
			...
			onLanguageSelectDialogShow: function (oEvent) {
				...
				if (!this._actionSheet) {
					this._actionSheet = sap.ui.xmlfragment(
						"com.bosch.sbs.vuu7hc.ui.fragment.LanguageList",
						this
					);
			...
			manageLanguage: function (oEvent) {
				...
				if (!this.languageDialog) {
					Fragment.load({
						id: "languageFragment",
						name: "com.bosch.sbs.vuu7hc.ui.fragment.LanguagePreference",
						controller: this
					}).then(oDialog => {
