sap.ui.define([
	...
	return Controller.extend("com.bosch.sbs.vuu7hc.ui.controller.ValueHelpDialogInputSuggestions", {
		onInit: function () {
			this._oMultiInput = this.getView().byId("multiInput");
			this._oMultiInput.setTokens(this._getDefaultTokens());
			this._oMultiInput.addValidator(this._onMultiInputValidate);

			this.oColModel = new JSONModel(sap.ui.require.toUrl("com/bosch/sbs/vuu7hc/ui/mockdata") + "/columnsModel.json");
			this.oProductsModel = new JSONModel(sap.ui.require.toUrl("com/bosch/sbs/vuu7hc/ui/mockdata") + "/valueHelpProducts.json");
		...
		onValueHelpRequested: function() {
			...
			Fragment.load({
				name: "com.bosch.sbs.vuu7hc.ui.fragment.ValueHelpDialogInputSuggestions",
				controller: this
