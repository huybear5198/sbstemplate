sap.ui.define([
    ...
    return BaseController.extend("com.bosch.sbs.vuu7hc.ui.controller.MyController", {

        // used for app router deployment
        remoteHost: "/comboschsbsvuu7hcui/backend", 
        ...
        loadMockbColumnbData: function ( ) {
            return this.$httpGet(sap.ui.require.toUrl("com/bosch/sbs/vuu7hc/ui/mockdata/bColumns.json"), null, null, null);
        },
