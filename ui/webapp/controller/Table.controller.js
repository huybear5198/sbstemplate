sap.ui.define([
	...
	return MyController.extend("com.bosch.sbs.vuu7hc.ui.controller.Table", {
		_aTableData: [],
		_aTableFilters: {},
		_oTableSort: {},
		_devicePhone: false,
		...
		initSampleDataModel : function() {
			...
			// jQuery.ajax(sap.ui.require.toUrl("com/bosch/sbs/vuu7hc/ui/mockdata/products.json"), {
			// 	dataType: "json",
		...
		onbSettingDialogPress: function (oEvent) {
			if (!this.bSettingDialog) {
				Fragment.load({
					id: "bSettingFragment",
					name: "com.bosch.sbs.vuu7hc.ui.fragment.TableSetting",
					controller: this
				}).then(oDialog => {
		...
		_Variant_manageView: function (oEvent) {
			...
			if (!this._oDialog) {
				Fragment.load({
					name: "com.bosch.sbs.vuu7hc.ui.fragment.VariantManagement",
					controller: this
